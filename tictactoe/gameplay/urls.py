...
from django.contrib.auth.views import LoginView, LogoutView       #9.3 9.2 deki template in içerisinde kodları yazdıktan sonra url kısmına geliyor ve kodları yazıyoruz. 
